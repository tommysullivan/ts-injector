Feature: Spyglass Packaging
  ...
  Scenario Outline: Given a desired package details, determine the correct repository
    ...
    Examples:
      ...
      | mapr-core       | 6.0.0                | development     | ubuntu           | http://artifactory.devops.lab/artifactory/list/prestage/releases-dev/v6.0.0/ubuntu/  |
      | mapr-hbase-rest | 1.1.1                | production      | ubuntu           | http://package.mapr.com/releases/ecosystem-5.x/ubuntu                                |
      ...
      | mapr-core       | 6.0.0                | development     | Ubuntu           | http://artifactory.devops.lab/artifactory/list/prestage/releases-dev/v6.0.0/ubuntu/  |
      | mapr-core       | 6.0.0                | development     | suse             | http://yum.qa.lab/mapr-suse                                                          |
      | mapr-core       | 6.0.0                | development     | redhat           | http://artifactory.devops.lab/artifactory/list/prestage/releases-dev/v6.0.0/redhat/  |
      ...
      | mapr-core       | 5.2.0                | testing         | ubuntu           | http://apt.qa.lab/v5.2.0                                                             |
      | mapr-grafana    | 3.0.4                | testing         | redhat           | http://artifactory.devops.lab/artifactory/prestage/releases-dev/MEP/MEP-1.0.0/redhat |

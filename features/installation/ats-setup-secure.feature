Feature: Package Manager Installation
  ...
  Scenario: Setup ATS after cluster install
    ...
    And I perform the following ssh commands on each node in the cluster as user "mapruser1" with password "mapruser1":
    """
    echo 'mapruser1' | maprlogin password
    """
    And I perform the following ssh commands on each node in the cluster as user "mapruser2" with password "mapruser2":
    """
    echo 'mapruser2' | maprlogin password
    """
    And I perform the following ssh commands on each node in the cluster as user "m7user1" with password "m7user1":
    """
    echo 'm7user1' | maprlogin password
    """
    And I perform the following ssh commands on each node in the cluster as user "m7user2" with password "m7user2":
    """
    echo 'm7user2' | maprlogin password
    """
    And I perform the following ssh commands on each node in the cluster as user "m7user3" with password "m7user3":
    """
    echo 'm7user3' | maprlogin password
    """
    And I perform the following ssh commands on each node in the cluster as user "m7user4" with password "m7user4":
    """
    echo 'm7user4' | maprlogin password
    """

...
module.exports = function(configJSON) {
    return {
        ...
        newMCSRestClient: function() {
            var envConfig = configJSON['environments']['dev'];
            return MCSRestClient(this, envConfig['mcsProtocolHostAndOptionalPort'], envConfig['mcsLoginPath']);
        },
        newMCSRestSession: function(authedRestClient) {
            return MCSRestSession(this, authedRestClient);
        },
        newMCSDashboardInfo: function(dashboardInfoJSONObject) {
            return MCSDashboardInfo(dashboardInfoJSONObject);
        },

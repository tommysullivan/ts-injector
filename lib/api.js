...
module.exports = function(configJSON) {
    ...
    return {
        ...
        newRESTResponse: function(error, nativeResponse) {
            return RESTResponse(error, nativeResponse)
        },
        ...
        newClusterTestResult: function(stdout, stderr, processExitCode, cucumberRunConfig, versionGraph, versionGraphError) {
            return ClusterTestResult(stdout, stderr, processExitCode, cucumberRunConfig, versionGraph, versionGraphError);
        },

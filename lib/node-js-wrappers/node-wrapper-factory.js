...
var NodeWrapperFactory = (function () {
    ...
    NodeWrapperFactory.prototype.newStringHelper = function () {
        return new string_helper_1.default();
    };
    ...
    NodeWrapperFactory.prototype.fileSystem = function () {
        return new file_system_1.default(this.fsModule, this.typedJSON, this.collections, this.errors, this, this.promiseFactory);
    };
    NodeWrapperFactory.prototype.newStringBuffer = function (content) {

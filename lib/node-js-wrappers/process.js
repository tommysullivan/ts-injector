...
var Process = (function () {
    ...
    Process.prototype.environmentVariableNamedOrDefault = function (name, defaultValueIfNotDefined) {
        return this.environmentVariableNamedOrLazyDefault(name, function () { return defaultValueIfNotDefined; });
    };
    Process.prototype.environmentVariableNamedOrLazyDefault = function (name, defaultValueFuncIfNotDefined) {
    ...
    Process.prototype.executeNodeProcess = function (command, environmentVariables) {
        ...
        return this.promiseFactory.newPromise(function (resolve, reject) {
            ...
            var cukeProcess = _this.childProcess.exec(_this.pathToNodeJSExecutable() + " " + command, {
                env: env.toJSON(),
            ...
            var closed = false;
            var exited = false;
            var attemptToResolvePromise = function (processExitCode) {
                if (closed && exited) {
            ...
            cukeProcess.on('exit', function (processExitCode, signal) {
                exited = true;

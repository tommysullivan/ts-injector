...
var NodeFrameworkLoader = (function () {
    ...
    NodeFrameworkLoader.prototype.loadFramework = function () {
        return new framework_1.default(this.frameworkConfig, this.process, this.fileSystem, uuidGenerator, this.collections, this.errors, this.promiseFactory, this.typedJSON, this.sshAPI, this.nodeWrapperFactory, chai, this.console, this.rest, this.expressWrappers, shellEscape);
    };
    ...
    Object.defineProperty(NodeFrameworkLoader.prototype, "frameworkConfigLoader", {
        get: function () {
            return new config_loader_1.default(this.process, this.fileSystem, this.nodeWrapperFactory.path);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(NodeFrameworkLoader.prototype, "sshAPI", {
        get: function () {
            return new ssh_api_1.default(nodemiralModule, this.promiseFactory, this.nodeWrapperFactory, this.collections, this.frameworkConfig.ssh);
        },
        enumerable: true,
        configurable: true
    });

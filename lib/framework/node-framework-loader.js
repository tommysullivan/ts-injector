...
var NodeFrameworkLoader = (function () {
    ...
    NodeFrameworkLoader.prototype.loadFramework = function () {
        return new framework_1.default(this.frameworkConfig, this.process, this.fileSystem, uuidGenerator, this.collections, this.errors, this.promiseFactory, this.typedJSON, this.sshAPI, this.nodeWrapperFactory, chai, this.console, this.rest, this.expressWrappers);
    };

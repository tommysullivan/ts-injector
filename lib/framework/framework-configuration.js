...
var spyglass_config_1 = require("../spyglass/spyglass-config");
var esxi_configuration_1 = require("../esxi/configuration/esxi-configuration");
var versioning_config_1 = require("../versioning/versioning-config");
...
var FrameworkConfiguration = (function () {
    function FrameworkConfiguration(frameworkConfigJSON, basePathToUseForConfiguredRelativePaths, path) {
    ...
    Object.defineProperty(FrameworkConfiguration.prototype, "testPortalConfig", {
        get: function () {
            return new test_portal_configuration_1.default(this.frameworkConfigJSON.jsonObjectNamed('testPortal'), this.basePathToUseForConfiguredRelativePaths, this.path);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(FrameworkConfiguration.prototype, "clusterTesting", {
        get: function () {
            return new cluster_testing_configuration_1.default(this.frameworkConfigJSON.jsonObjectNamed('clusterTesting'), this.basePathToUseForConfiguredRelativePaths, this.path);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(FrameworkConfiguration.prototype, "spyglassConfig", {
        get: function () {
            return new spyglass_config_1.default(this.frameworkConfigJSON.jsonObjectNamed('spyglass'));
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(FrameworkConfiguration.prototype, "versioningConfig", {
        get: function () {
            return new versioning_config_1.default(this.frameworkConfigJSON.jsonObjectNamed('versioning'));
        },
        enumerable: true,
        configurable: true
    });

...
var FrameworkConfiguration = (function () {
    function FrameworkConfiguration(frameworkConfigJSON, basePathToUseForConfiguredRelativePaths, path, process, collections) {
    ...
    Object.defineProperty(FrameworkConfiguration.prototype, "clusterTesting", {
        get: function () {
            return new cluster_testing_configuration_1.default(this.frameworkConfigJSON.jsonObjectNamed('clusterTesting'), this.basePathToUseForConfiguredRelativePaths, this.path, this.process, this.collections);
        },
        enumerable: true,
        configurable: true
    });

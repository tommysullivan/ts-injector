...
var ConfigLoader = (function () {
    ...
    ConfigLoader.prototype.loadConfig = function () {
        return new framework_configuration_1.default(this.fileSystem.readJSONObjectFileSync(this.configPath), this.basePathToUseForConfiguredRelativePaths, this.path);
    };

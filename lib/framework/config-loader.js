...
var ConfigLoader = (function () {
    function ConfigLoader(process, fileSystem, path, collections) {
    ...
    ConfigLoader.prototype.loadConfig = function () {
        return new framework_configuration_1.default(this.fileSystem.readJSONObjectFileSync(this.configPath), this.basePathToUseForConfiguredRelativePaths, this.path, this.process, this.collections);
    };

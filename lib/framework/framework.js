...
var Framework = (function () {
    function Framework(frameworkConfig, process, fileSystem, uuidGenerator, collections, errors, promiseFactory, typedJSON, sshAPI, nodeWrapperFactory, chai, console, rest, expressWrappers, shellEscape) {
    ...
    Framework.prototype.shellEscape = function (shellText) {
    ...
    Object.defineProperty(Framework.prototype, "clusters", {
        get: function () { return new clusters_1.default(this.frameworkConfig.clustersConfig, this.esxi, this.errors, this.collections); },
        enumerable: true,
        configurable: true
    });

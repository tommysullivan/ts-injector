    ...
    return {
        ...
        executeShellCommands: function(commands) {
            ...
            return getShellSession()
                .then(sshSession => sshSession.executeCommands(commandsWithResolvedPlaceholders));
        },
        ...
        versionGraph: function() {
            return getShellSession()
                ...
                .then(commandResultSet=>api.newNodeVersionGraph(this.host(), commandResultSet));
        },
        ...
        repoListCommand: function() { return repositories.repoListCommandFor(this.operatingSystem());},
        packageListCommand: function() { return repositories.packageListCommandFor(this.operatingSystem()); },

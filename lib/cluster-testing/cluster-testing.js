...
var ClusterTesting = (function () {
    function ClusterTesting(clusterTestingConfiguration, promiseFactory, sshClient, collections, versioning, mcs, openTSDB, installer, elasticSearch, serviceDiscoverer, esxi, clusters) {
    ...
    ClusterTesting.prototype.newNodeUnderTest = function (nodeConfiguration) {
        return new node_under_test_1.default(nodeConfiguration, this.sshClient, this.promiseFactory, this.collections, this.mcs, this.openTSDB, this.installer, this.elasticSearch, this.versioning);
    };

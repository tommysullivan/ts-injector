...
var node_repo_url_provider_1 = require("./node-repo-url-provider");
var ClusterTesting = (function () {
    function ClusterTesting(clusterTestingConfiguration, promiseFactory, sshClient, collections, versioning, mcs, openTSDB, installer, elasticSearch, serviceDiscoverer, esxi, clusters, repositories) {
    ...
    ClusterTesting.prototype.newClusterUnderTest = function (clusterConfiguration) {
        var _this = this;
        return new cluster_under_test_1.default(this.clusterTestingConfiguration.clusterInstallerConfiguration, this.promiseFactory, clusterConfiguration.nodes.map(function (n) { return _this.newNodeUnderTest(n); }), this.versioning, clusterConfiguration, this.serviceDiscoverer, this, this.newClusterInstaller());
    };
    ClusterTesting.prototype.newClusterInstaller = function () {
        return new cluster_installer_1.default(this.promiseFactory, this.versioning.serviceSet(), this.clusterTestingConfiguration.clusterInstallerConfiguration);
    };
    ClusterTesting.prototype.newNodeUnderTest = function (nodeConfiguration) {
        return new node_under_test_1.default(nodeConfiguration, this.sshClient, this.promiseFactory, this.collections, this.mcs, this.openTSDB, this.installer, this.elasticSearch, this.versioning, this.newNodeRepoUrlProvider());
    };
    ClusterTesting.prototype.newNodeRepoUrlProvider = function () {
        return new node_repo_url_provider_1.default(this.repositories.newRepositoryUrlProvider(), this.clusterTestingConfiguration.phaseOfDevelopment, this.clusterTestingConfiguration.maprCoreVersion);
    };

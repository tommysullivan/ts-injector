...
var NodeUnderTest = (function () {
    function NodeUnderTest(nodeConfiguration, sshClient, promiseFactory, collections, mcs, openTSDB, installer, elasticSearch, versioning, packaging, releasePhase) {
    ...
    Object.defineProperty(NodeUnderTest.prototype, "packageManager", {
        get: function () {
    ...
    NodeUnderTest.prototype.executeShellCommands = function (commandsWithPlaceholders) {
        var _this = this;
        var commands = commandsWithPlaceholders.map(function (c) { return c.replace('{{packageCommand}}', _this.packageManager.packageCommand); });
    ...
    Object.defineProperty(NodeUnderTest.prototype, "packages", {
        get: function () {
            var _this = this;
            return this.releasePhase.packages.filter(function (p) { return _this.isHostingService(p.name); });
        },
        enumerable: true,
        configurable: true
    });

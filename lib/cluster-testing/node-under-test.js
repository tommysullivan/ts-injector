...
var NodeUnderTest = (function () {
    ...
    Object.defineProperty(NodeUnderTest.prototype, "repo", {
        get: function () {
    ...
    NodeUnderTest.prototype.executeCopyCommand = function (localPath, remotePath) {
        return this.newSSHSession()
            .then(function (sshSession) { return sshSession.copyCommand(localPath, remotePath); });
    };

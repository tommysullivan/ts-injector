...
var ClusterUnderTest = (function () {
    function ClusterUnderTest(clusterInstallerConfiguration, promiseFactory, clusterNodes, versioning, clusterConfig, serviceDiscoverer, clusterTesting, clusterInstaller, packaging) {
    ...
    ClusterUnderTest.prototype.powerOff = function () {
    ...
    ClusterUnderTest.prototype.uploadToEachNode = function (localPath, remotePath) {
        return this.promiseFactory.newGroupPromise(this.clusterNodes.map(function (n) { return n.upload(localPath, remotePath); }));
    };

...
var Cucumber = (function () {
    ...
    Cucumber.prototype.newCucumberTestResult = function (cucumberFeatureResults, processResult, cucumberRunConfiguration, resultAcquisitionError) {
        return new cucumber_test_result_1.default(cucumberFeatureResults, processResult, case_insensitive_comparator_1.default, cucumberRunConfiguration, resultAcquisitionError, this.errors);
    };
    ...
    Cucumber.prototype.getColumnArrayFromTable = function (table, column) {
        return this.collections.newList(table.rows().map(function (r) { return r[column]; }));
    };
    return Cucumber;
}());

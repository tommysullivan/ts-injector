...
var Clusters = (function () {
    function Clusters(clusterJSONs, esxi, errors, operatingSystems) {
    ...
    Clusters.prototype.newClusterConfiguration = function (clusterConfigJSON) {
        return new cluster_configuration_1.default(clusterConfigJSON, this.esxi, this.operatingSystems);
    };
    return Clusters;
}());

...
var ClusterConfiguration = (function () {
    function ClusterConfiguration(configJSON, esxi, collections) {
    ...
    Object.defineProperty(ClusterConfiguration.prototype, "nodes", {
        get: function () {
            var _this = this;
            return this.configJSON.listOfJSONObjectsNamed('nodes').map(function (nodeJSON) { return new node_configuration_1.default(nodeJSON, _this.collections); });
        },
        enumerable: true,
        configurable: true
    });

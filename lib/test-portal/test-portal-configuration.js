...
var TestPortalConfiguration = (function () {
    function TestPortalConfiguration(configJSON, basePathToUseForConfiguredRelativePaths, path, process) {
        this.configJSON = configJSON;
        this.basePathToUseForConfiguredRelativePaths = basePathToUseForConfiguredRelativePaths;
        this.path = path;
        this.process = process;
    }
    Object.defineProperty(TestPortalConfiguration.prototype, "portalId", {
        get: function () { return this.process.environmentVariableNamedOrDefault('portalId', 'local'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TestPortalConfiguration.prototype, "envSpecificConfig", {
        get: function () { return this.configJSON.jsonObjectNamed('environmentSpecificConfig').jsonObjectNamed(this.portalId); },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(TestPortalConfiguration.prototype, "clustersWebRoute", {
        get: function () { return this.configJSON.stringPropertyNamed('clustersWebRoute'); },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(TestPortalConfiguration.prototype, "httpPort", {
        get: function () { return this.envSpecificConfig.numericPropertyNamed('httpPort'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TestPortalConfiguration.prototype, "hostName", {
        get: function () { return this.envSpecificConfig.stringPropertyNamed('hostName'); },
        enumerable: true,
        configurable: true
    });

        ...
        return {
            ...
            filter: function(query) {
                var filteredScenarios = query.hasOneOfTheseTags == null || query.hasOneOfTheseTags.length == 0
                    ? scenarioModels
                    : scenarioModels.filter(scenario => scenario.matchesTags(query.hasOneOfTheseTags));
                ...
                filteredScenarios = query.automationType == 'automatedAndManual'
                    ...
                    : filteredScenarios.filter(
                        scenario => scenario.matchesTags(query.automationType == 'manualOnly' ? ['@Manual'] : ['~@Manual'])
                    );

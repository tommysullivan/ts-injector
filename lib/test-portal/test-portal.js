...
var clusters_controller_1 = require("./controllers/clusters-controller");
var cluster_revert_requests_controller_1 = require("./controllers/cluster-revert-requests-controller");
var TestPortal = (function () {
    function TestPortal(testPortalConfiguration, expressWrappers, nodeWrapperFactory, jira, process, promiseFactory, collections, console, clustersJSON, clusterTesting) {
